...
int ndo_write_object_config(ndo_query_context *q_ctx, int config_type, ndo_queue_coordinator *coordinator)
{
    ...
    write_result = ndo_write_hostescalations(q_ctx, config_type, hostescalation_list);
    ...
    write_result = ndo_write_serviceescalations(q_ctx, config_type, serviceescalation_list);
...
int ndo_write_contact_objects(ndo_query_context *q_ctx, int config_type, contact * contact_list)
{
    ...
    char addresses_query_values[] = "(1,(SELECT object_id FROM nagios_objects WHERE objecttype_id = 10 AND name1 = ? AND is_active = 1 LIMIT 1),?,?),";
    ...
    char notificationcommands_query_values[] = "(1,(SELECT object_id FROM nagios_objects WHERE objecttype_id = 10 AND name1 = ? AND is_active = 1 LIMIT 1),?,(SELECT object_id FROM nagios_objects WHERE objecttype_id = 12 AND name1 = ? LIMIT 1)),";
...
int ndo_write_hostescalations(ndo_query_context *q_ctx, int config_type, hostescalation *hostescalation_list)
{
    trace_func_args("config_type=%d", config_type);
    int ndo_return = NDO_OK;
    ...
    ndo_write_hostescalation_contactgroups(q_ctx, hostescalation_ids, hostescalation_list);
    ndo_write_hostescalation_contacts(q_ctx, hostescalation_ids, hostescalation_list);
...
int ndo_write_hostescalation_contactgroups(ndo_query_context *q_ctx, int * hostescalation_ids, hostescalation * hostescalation_list)
{
...
int ndo_write_hostescalation_contacts(ndo_query_context *q_ctx, int * hostescalation_ids, hostescalation * hostescalation_list)
{
    trace_func_args("hostescalation_ids=%p", hostescalation_ids);
    int ndo_return = NDO_OK;
...
int ndo_write_serviceescalations(ndo_query_context *q_ctx, int config_type, serviceescalation * serviceescalation_list)
{
    trace_func_args("config_type=%d", config_type);
    int ndo_return = NDO_OK;
    ...
    ndo_write_serviceescalation_contactgroups(q_ctx, serviceescalation_ids, serviceescalation_list);
    ndo_write_serviceescalation_contacts(q_ctx, serviceescalation_ids, serviceescalation_list);
...
int ndo_write_serviceescalation_contactgroups(ndo_query_context *q_ctx, int * serviceescalation_ids, serviceescalation *serviceescalation_list)
{
...
int ndo_write_serviceescalation_contacts(ndo_query_context *q_ctx, int * serviceescalation_ids, serviceescalation *serviceescalation_list)
{
    trace_func_args("serviceescalation_ids=%p", serviceescalation_ids);
    int ndo_return = NDO_OK;
